...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScreenerClass) DeepCopyInto(out *ScreenerClass) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScreenerClass.
func (in *ScreenerClass) DeepCopy() *ScreenerClass {
	if in == nil {
		return nil
	}
	out := new(ScreenerClass)
	in.DeepCopyInto(out)
	return out
}
