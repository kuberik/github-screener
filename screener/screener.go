...
func Start(class string, operatorProducers ...controllers.ScreenerOperatorProducer) {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "0f59fc61.kuberik.io",
	})
	if err != nil {
	...
	if err = (&controllers.ScreenerReconciler{
		...
		ScreenerOperatorProducers: operatorProducers,
